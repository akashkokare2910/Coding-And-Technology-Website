...
<head>
    ...
    <title>Searching Text Strings From Files Using Python</title>
</head>
...
<div class="relative bg-white overflow-hidden">
    ...
    <div class="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
      ...
      <main class="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
        <div class="sm:text-center lg:text-left">
          ...
          Searching Text Strings From Files 
            <br class="xl:hidden">
            <span class="text-indigo-600">Using Python</span>
          </h2>
          <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
           In this article, we are gonna see, how to search for single or multiple strings in a file and get all the matched lines along with their line numbers.
          </p>

          <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
        <strong> Going Through Following Steps to create project: </strong>
        </p>
        <span class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
          
    <p><span>1. Check if a string exists in a file.</span></p>
    <p><span>2. Create an empty list of tuples.</span></p>
    <p><span>3. Open the file at the given path in read-only mode.</span></p>
    <p><span>2. Iterates over each line in the file one by one.
          ...
          <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
            ...
            <div class="mt-3 sm:mt-0 sm:ml-3">
              <a href="https://github.com/akashkokare2910/Programming-Lust/blob/main/Text_Search.py" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-indigo-700 bg-indigo-100 hover:text-indigo-600 hover:bg-indigo-50 focus:outline-none focus:shadow-outline-indigo focus:border-indigo-300 transition duration-150 ease-in-out md:py-4 md:text-lg md:px-10">
                Get a Github Code
              </a>
            </div>
          </div>
  ...
  <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
    <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="Texts.gif" alt="">
  </div>
</div>
&nbsp
