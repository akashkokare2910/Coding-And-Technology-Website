...
<head>
    ...
    <title>Youtube video downloader using Python </title>
</head>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="index4.php">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        ...
        <div class="rounded-lg shadow-md">
          <div class="rounded-lg bg-white shadow-xs overflow-hidden" role="menu" aria-orientation="vertical" aria-labelledby="main-menu">
            <div class="px-5 pt-4 flex items-center justify-between">
              <div>
                <img class="h-8 w-auto" src="Calculator.gif" alt="">
              </div>
              <div class="-mr-2">
        ...
        <div class="sm:text-center lg:text-left">
          <h2 class="text-4xl tracking-tight leading-10 font-extrabold text-gray-900 sm:text-5xl sm:leading-none md:text-6xl">
           Youtube video downloader GUI
            <br class="xl:hidden">
            <span class="text-indigo-600">Using Python</span>
          </h2>
          <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
          YouTube is a very popular video-sharing web application, website. YouTube allows users to upload, view, rate, share, add to playlists, report, comment on videos, and subscribe to other users. </p>
          <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
          So, we gonna create a basic youtube downloader GUI using <strong>Tkinter</strong> in python. Using the Python Tkinter package, this task is very simple-efficient-safe. 
          <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
          <strong>Tkinter:</strong> is most commonly used method for developing GUI(Graphic User Interface). It is a standard Python interface to the Tk GUI toolkit shipped with Python. Python with tkinter outputs the fastest and easiest way to create the GUI applications.
          </p>

          <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
        <strong>  Steps involving to create GUI Application :</strong>
        </p>
        <span class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
          
    <p><span>1. Importing the module – tkinter </span></p>
    <p><span>2. Create the main window (container) </span></p>
    <p><span>3. Add any number of widgets to the main window</span></p>
   
      </span>
      <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
         So Let’s create a GUI based youtube downloader using Python Tkinter module, which can easily download the desired video file from world's largest video sharing platform and that's <strong> Youtube </strong>
        </p>
          <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
            <div class="rounded-md shadow">
              <a href="index4.php" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo transition duration-150 ease-in-out md:py-4 md:text-lg md:px-10">
                Explore More Projects
              </a>
            </div>
            <div class="mt-3 sm:mt-0 sm:ml-3">
              <a href="https://github.com/akashkokare2910/Programming-Lust/blob/main/UtubeDownloader.py" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-indigo-700 bg-indigo-100 hover:text-indigo-600 hover:bg-indigo-50 focus:outline-none focus:shadow-outline-indigo focus:border-indigo-300 transition duration-150 ease-in-out md:py-4 md:text-lg md:px-10">
                Get a Github Code
              </a>
            </div>
          </div>
  ...
  <div class="container text-center text-md-left">
    ...
    <div class="row">
      ...
      <div class="col-md-2 mx-auto">
        ...
        <!-- Links -->
        <h5 class="font-weight-bold text-uppercase mt-3 mb-4">Coding</h5>

        <ul class="list-unstyled">
          <li>
            <a href="#!"> Snake Game in Python</a>
          </li>
          <li>
          </hr>
            <a href="#!">Turtle Game Using Python</a>
          </li>
          <li>
            <a href="#!"> Searching Text Strings From Files Using Python</a>
          </li>
          <li>
            <a href="#!">Link 4</a>
          </li>
      ...
      <div class="col-md-2 mx-auto">
        ...
        <!-- Links -->
        <h5 class="font-weight-bold text-uppercase mt-3 mb-4">Technology Blogs</h5>
